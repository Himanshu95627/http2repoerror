...
function fetchEmployees() {
    ...
    fetch("https://localhost:9001/api/rest/employees")
...
function fetchEmployeeById() {
    ...
    fetch(`https://localhost:9001/api/rest/employees/${employeeId}`)
        .then(response => response.json())
        .then(data => {
...
function deleteEmployee() {
    ...
    fetch(`https://localhost:9001/api/rest/employees?id=${employeeId}`, {
        method: "DELETE"
    })
    .then(response => {
        if (response.ok) {
...
function updateEmployee() {
    ...
    fetch(`https://localhost:9001/api/rest/employees/${employeeId}`)
        ...
        .then(existingEmployee => {
            ...
            return fetch(`https://localhost:9001/api/rest/employees/${employeeId}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
...
function connectWebSocket() {
    webSocket = new WebSocket("wss://localhost:9001/api/websocket");
